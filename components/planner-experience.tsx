  ...
  return (
    <main className="grid-fade min-h-screen">
      <section className="mx-auto flex w-full max-w-7xl flex-col px-4 py-5 sm:px-6 lg:px-8">
        <header className="glass-panel mb-5 flex flex-col gap-3 rounded-[1.2rem] border border-border-soft px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
          <BrandLogo />
...
function BrandLogo() {
  return (
    <Link className="brand-lockup" href="/">
      ...
      <span>
        <span className="block font-serif text-[1.55rem] leading-none text-slate-950 sm:text-[2rem]">
          WeekendWanderer
        </span>
        <span className="compact-label mt-1 block text-[var(--color-ink-muted)]">
